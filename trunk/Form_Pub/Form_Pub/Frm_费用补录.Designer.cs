namespace Form_Pub
{
    partial class Frm_费用补录
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Frm_费用补录));
            ...
            this.Name = "Frm_费用补录";
            this.Text = "费用补录";
            this.Load += new System.EventHandler(this.Frm_费用补录_Load);
